{
  inputs =
    let
      version = "1.9.0";
system = "x86_64-linux";
devenv_root = "/home/alexneargarder/repos/BroforceMods";
devenv_dotfile = "/home/alexneargarder/repos/BroforceMods/.devenv";
devenv_dotfile_path = ./.devenv;
devenv_tmpdir = "/run/user/1000";
devenv_runtime = "/run/user/1000/devenv-12f85ec";
devenv_istesting = false;
devenv_direnvrc_latest_version = 1;
container_name = null;
active_profiles = [ ];
hostname = "alexlaptop";
username = "alexneargarder";
