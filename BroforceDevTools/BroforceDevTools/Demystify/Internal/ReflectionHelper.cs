...
namespace System.Diagnostics.Internal
{
    ...
    public static class ReflectionHelper
    {
        ...
        {
            if (tranformerNamesLazyPropertyInfo == null)
                tranformerNamesLazyPropertyInfo = attributeType.GetProperty("TransformNames", BindingFlags.Instance | BindingFlags.Public);
