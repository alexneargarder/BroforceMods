    ...
    public class Bolt : PredabroSpear
    {
        ...
        protected override void Awake()
        {
            ...
            if ( this.explosive )
            {
                ...
                this.explosionSounds[0] = ResourcesController.GetAudioClip(Path.Combine(directoryPath, "sounds"), "explosion1.wav");
                this.explosionSounds[1] = ResourcesController.GetAudioClip( Path.Combine(directoryPath, "sounds"), "explosion2.wav");
            }
        }
